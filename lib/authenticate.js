...
/* --------------------------------------------
	...
	* configur this route based on your target website
	*/
function success (page) {
	return !page.url().includes('/login');
}

export default async function authenticate (browserContext, page, targetUrl) {
	...
	notify({ m: 'Login required...', d: 'cyan' });
	/* --------------------------------------------
